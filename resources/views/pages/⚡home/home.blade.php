<section class='h-screen overflow-hidden'>
    <div class="flex relative h-full items-center justify-center text-center">
        ...
        <div class="flex flex-col items-center justify-center text-center gap-2 wrapper">
            ...
            <div class="flex flex-col justify-center gap-4 md:gap-8 sm:flex-row mt-12 sm:mt-2 lg:mt-8">
                ...
                <a href="{{ route('gallery') }}"
                    class="uppercase tracking-[1.2px] px-10 py-4 font-semibold border-2 border-accent/30 hover:text-tertiary btn-animation after:bg-white after:outline-white after:outline-2">View
                    Gallery</a>
            </div>
        </div>
    </div>
